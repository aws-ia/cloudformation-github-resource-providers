...
1. Write the JSON schema describing your resource, [github-repositories-repository.json](./github-repositories-repository.json)
2. Implement your resource handlers in [handlers.ts](./github-repositories-repository/handlers.ts)

> Don't modify [models.ts](./github-repositories-repository/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
