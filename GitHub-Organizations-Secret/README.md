...
1. Write the JSON schema describing your resource, [github-organizations-secret.json](./github-organizations-secret.json)
2. Implement your resource handlers in [handlers.ts](./github-organizations-secret/handlers.ts)

> Don't modify [models.ts](./github-organizations-secret/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
