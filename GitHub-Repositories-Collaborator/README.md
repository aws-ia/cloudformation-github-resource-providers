...
1. Write the JSON schema describing your resource, [github-repositories-collaborator.json](./github-repositories-collaborator.json)
2. Implement your resource handlers in [handlers.ts](./github-repositories-collaborator/handlers.ts)

> Don't modify [models.ts](./github-repositories-collaborator/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
