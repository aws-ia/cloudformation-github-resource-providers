...
This resource type manages a [GitHub Organization Collaborator][7]
...
For example:
  ...
  --type-name GitHub::Organizations::Collaborator \
...
### Give a user from outside an organisation access to a repository

```yaml
---
AWSTemplateFormatVersion: '2010-09-09'
Description: Gives external-user access to ACME-Repo
Resources:
