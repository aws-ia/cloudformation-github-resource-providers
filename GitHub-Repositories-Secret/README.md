...
1. Write the JSON schema describing your resource, [github-repositories-secret.json](./github-repositories-secret.json)
2. Implement your resource handlers in [handlers.ts](./github-repositories-secret/handlers.ts)

> Don't modify [models.ts](./github-repositories-secret/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
