...
1. Write the JSON schema describing your resource, [github-git-tag.json](./github-git-tag.json)
2. Implement your resource handlers in [handlers.ts](./github-git-tag/handlers.ts)

> Don't modify [models.ts](./github-git-tag/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
