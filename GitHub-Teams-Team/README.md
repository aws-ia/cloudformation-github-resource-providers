...
1. Write the JSON schema describing your resource, [github-teams-team.json](./github-teams-team.json)
2. Implement your resource handlers in [handlers.ts.bak](./github-teams-team/handlers.ts)

> Don't modify [models.ts](./github-teams-team/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
