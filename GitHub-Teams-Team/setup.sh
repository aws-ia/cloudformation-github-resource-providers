...
REPO_UUID=$(uuidgen)
cat example-inputs/inputs_1_create.json | sed "s/GITHUB_ORG/${GITHUB_ORG}/g" > inputs/inputs_1_create.json
cat example-inputs/inputs_1_update.json | sed "s/GITHUB_ORG/${GITHUB_ORG}/g" > inputs/inputs_1_update.json
cp example-inputs/inputs_1_invalid.json inputs/

cat test/integ.yml | sed "s/GITHUB_ORG/${GITHUB_ORG}/" > test/integ-unique.yml
