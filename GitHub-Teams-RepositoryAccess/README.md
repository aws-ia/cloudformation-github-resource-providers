...
1. Write the JSON schema describing your resource, [github-teams-repositoryaccess.json](./github-teams-repositoryaccess.json)
2. Implement your resource handlers in [handlers.ts](./github-teams-repositoryaccess/handlers.ts)

> Don't modify [models.ts](./github-teams-repositoryaccess/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
