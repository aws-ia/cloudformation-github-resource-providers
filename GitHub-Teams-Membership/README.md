...
1. Write the JSON schema describing your resource, [github-teams-membership.json](./github-teams-membership.json)
2. Implement your resource handlers in [handlers.ts](./github-teams-membership/handlers.ts)

> Don't modify [models.ts](./github-teams-membership/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
