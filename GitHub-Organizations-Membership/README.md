...
This resource type manages a [GitHub Organization Membership][5]
...
### Adds a user to an organization in GitHub

```yaml
---
AWSTemplateFormatVersion: '2010-09-09'
Description: Adds ACME-cloudformation-test-user to ACME-Cloudformation
Resources:
  Membership:
