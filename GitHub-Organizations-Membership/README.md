...
1. Write the JSON schema describing your resource, [github-organizations-membership.json](./github-organizations-membership.json)
2. Implement your resource handlers in [handlers.ts](./github-organizations-membership/handlers.ts)

> Don't modify [models.ts](./github-organizations-membership/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
