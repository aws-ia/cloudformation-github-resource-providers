...
1. Write the JSON schema describing your resource, [github-repositories-webhook.json](./github-repositories-webhook.json)
2. Implement your resource handlers in [handlers.ts](./github-repositories-webhook/handlers.ts)

> Don't modify [models.ts](./github-repositories-webhook/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
