...
#   Example
#
#   GITHUB_ORG=ericzbeard-aws-cep-testing GITHUB_REPO=ezbeard-github-test AWS_PROFILE=ezbeard-cep ./setup.sh
...
cat test/integ.yml | sed "s/GITHUB_ORG/${GITHUB_ORG}/g" | sed "s/GITHUB_REPO/${GITHUB_REPO}/g" > test/integ-unique.yml
